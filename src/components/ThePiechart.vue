<template>
  <section class="chart">
    <h1 class="chart__title" @click="test">Pie Chart</h1>
    <p class="text-center">
      <span class="chart-main-word">Pie</span> and doughnut charts are probably the most commonly used charts. They
    ...
    <div class="main-part">
      <div class="main-part__chart">
        <canvas ref="piechart_canvas" class="canvas"></canvas>
      </div>
...
function createChart() {
  ...
  currentChart = new Chart(piechart_canvas.value, {
    type: "pie",
    options: {},
    data: {
